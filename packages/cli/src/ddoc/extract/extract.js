...
const DesignDocumentSchema = typebox_1.Type.Object({
    ...
    options: typebox_1.Type.Optional(typebox_1.Type.Object({
        ...
        include_design: typebox_1.Type.Optional(typebox_1.Type.Boolean()), // eslint-disable-line
    })),
...
function default_1(src, opts) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const dbBackup = (yield readFIle(srcPath)).toString();
            if (!opts.noVerbose) {
            ...
            if (opts.format === 'json') {
                ...
                yield (0, mkdirp_1.default)(destFolder);
                for (const doc of designDocuments) {
                    ...
                    yield writeFile(dest, docString);
                }
                if (!opts.noVerbose) {
